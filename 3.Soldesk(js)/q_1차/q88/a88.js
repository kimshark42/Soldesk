...
document.write("ToDay :" + now.getDay() );   br(); // 요일. 0-일, 1-월, 2-화, 3-수, 4-목, 5-금, 6-토
...
document.write("ToMonth :" + now.getMonth() );   br(); // 달 데이터는 0부터시작이라 +1 해야 현재달이 나옴.
